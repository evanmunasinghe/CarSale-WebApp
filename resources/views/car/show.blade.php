          ...
          <div class="car-images-and-description">
            ...
            <div class="card car-detailed-description">
              ...
              <ul class="car-specifications">
                ...
                <x-car-specification :value="$car->features->bluetooth_connectivity">Bluetooth</x-car-specification>
                <x-car-specification :value="$car->features->remote_start">Keyless Entry</x-car-specification>
                <x-car-specification :value="$car->features->gps_navigation">GPS</x-car-specification>
                <x-car-specification :value="$car->features->heater_seats">Heated Seats</x-car-specification>
               <x-car-specification :value="$car->features->climate_control">Duel Climate Control</x-car-specification>
               <x-car-specification :value="$car->features->rear_parking_sensors">Parking Sensors</x-car-specification>
