                            ...
                            <tbody>
                               @forelse ($cars as $car)                 
                                <tr>
                                    <td>
                                        @if ($car->primaryImage)
                                            <img src="{{ $car->primaryImage->url }}" alt=""
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('car.destroy', $car) }}" method="POST" 
                                              onsubmit="return confirm('Are you sure you want to permanently delete this vehicle listing?');" 
                                ...
                                <tr>
                                  <td colspan="5" class="text-center p-large">
                                      No Cars Uploaded Yet <a href="{{ route('car.create') }}">Add New Car</a>
                                  </td>
                                </tr>
                                @endforelse
                            </tbody>
